  ...
  return (
    <VStack gap={{ base: 6, md: 8 }} align="stretch">
      ...
      <Box textAlign="center" mb={{ base: 2, md: 4 }}>
        <Heading as="h1" size={{ base: "xl", md: "2xl" }} color="secondary.800" mb={3} fontWeight="bold">
          Dashboard Overview
        </Heading>
        <Text color="secondary.600" fontSize={{ base: "lg", md: "xl" }} fontWeight="medium">
          Welcome back! Here&apos;s your account overview.
        </Text>
        <Box h="3px" bg="primary.500" w={{ base: "100px", md: "120px" }} mx="auto" borderRadius="full" mt={4} />
      </Box>
          ...
          <Card.Body p={{ base: 4, md: 6 }}>
            <Flex align="center" gap={3} mb={4}>
              ...
              <Box>
                ...
                <Text fontSize={{ base: "xs", md: "sm" }} color="accent.200" fontWeight="medium">
                  +3 this week
                </Text>
              </Box>
            </Flex>
  ...
  return (
    <VStack gap={{ base: 6, md: 8 }} align="stretch">
      <Box textAlign="center" mb={{ base: 2, md: 4 }}>
        ...
        <Box h="3px" bg="primary.500" w={{ base: "80px", md: "100px" }} mx="auto" borderRadius="full" mt={4} />
      </Box>
          ...
          >
            ...
            >
              <HStack gap={{ base: 3, md: 4 }}>
                <Icon as={MdReceipt} boxSize={{ base: 8, md: 10 }} color="primary.600" />
                <Box>
                  <Text fontWeight="bold" color="secondary.800" fontSize={{ base: "md", md: "lg" }}>
                    Target Store #{item}
                  </Text>
                  <Text fontSize={{ base: "xs", md: "sm" }} color="secondary.600" fontWeight="medium">
                    {new Date(Date.now() - item * 24 * 60 * 60 * 1000).toLocaleDateString()}
                  </Text>
                </Box>
              </HStack>
              <VStack align={{ base: "start", sm: "end" }} gap={1}>
                <Text fontWeight="bold" color="secondary.800" fontSize={{ base: "lg", md: "xl" }}>
                  ${(Math.random() * 100 + 10).toFixed(2)}
                </Text>
                <Text fontSize={{ base: "xs", md: "sm" }} color="accent.600" fontWeight="bold">
  ...
  return (
    <VStack gap={{ base: 6, md: 8 }} align="stretch">
      <Box textAlign="center" mb={{ base: 2, md: 4 }}>
        ...
        <Box h="3px" bg="accent.500" w={{ base: "130px", md: "150px" }} mx="auto" borderRadius="full" mt={4} />
      </Box>
        ...
        >
          <VStack gap={{ base: 4, md: 6 }}>
            ...
            <SimpleGrid columns={2} gap={{ base: 4, md: 6 }} w="full">
              ...
              <Box textAlign="center">
                <Text fontSize={{ base: "4xl", md: "5xl" }} fontWeight="bold" color="accent.200">
                  2
                </Text>
                <Text fontSize={{ base: "xs", md: "sm" }} color="whiteAlpha.800" fontWeight="semibold" textTransform="uppercase" letterSpacing="wide">
                  Successfully Joined
...
export default function DashboardPage() {
    ...
    return (
      ...
      >
        <VStack gap={4}>
          ...
          />
          <Text color="secondary.800">Loading...</Text>
        </VStack>
      </Box>
    );
  }
  ...
  return (
    <Grid h="100%" templateColumns={{ base: "1fr", md: "280px 1fr" }} bg="secondary.100">
      <GridItem 
